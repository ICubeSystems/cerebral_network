...
public class SynapticOutgoingMessageType extends OutgoingMessageType 
{
	 ...
	 */
	public static SynapticOutgoingMessageType ACK_RECEIVED = new SynapticOutgoingMessageType(0x05, ThreeWayEventAcknowledgementAffector.class);

	/**
	 * This message type is used to recieve acknowledgement of publish event
	 */
	public static SynapticOutgoingMessageType RELAYED_EVENT_ACk = new SynapticOutgoingMessageType(0x04, RelayEventAcknowledgementAffector.class);
	
	/**
	 * Synaptic node sends a notification that relay event acknowledged successfully and POR is deleted from snaptic side.
	 */
	public static SynapticOutgoingMessageType POR_DELETED = new SynapticOutgoingMessageType(0x0D, DeletePorAffector.class);
	
	/**
	 * 
	 */
	public static SynapticOutgoingMessageType STARTUP = new SynapticOutgoingMessageType(0x00, StartupAffector.class);
	/**
	 *  Credentials
	 */
	public static SynapticOutgoingMessageType CREDENTIALS = new SynapticOutgoingMessageType(0x01, CredentialsAffector.class);
	/**
	 * 
	 */
	public static SynapticOutgoingMessageType READY_CONFIRM = new SynapticOutgoingMessageType(0x07, ReadyConfirmedAffector.class);
	/**
	 * 
	 */ 
