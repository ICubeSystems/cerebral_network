...
public final class Emitter 
{
	 ...
	 */
	public static void emit(Event event) throws ImproperConnectorInstantiationException, IOException, EmitException
	{
		...
		try {
			...
			// TODO:Break here - throw EmitException such that the application code can handle
			NcephLogger.MESSAGE_LOGGER.error(new MessageLog.Builder()
					.messageId(message.decoder().getId())
					.action("EmitException")
					.logError(),e);
			throw new EmitException("EmitException: ", e);
		}
