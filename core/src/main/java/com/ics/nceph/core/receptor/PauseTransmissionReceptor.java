 ...
 * @since 21-Nov-2022
 */
public class PauseTransmissionReceptor extends Receptor 
{
	public PauseTransmissionReceptor(Message message, Connection incomingConnection) 
	{
	...
	public void process() 
	{
		NcephLogger.BACKPRESSURE_LOGGER.info(new BackpressureLog.Builder()
				...
				.data(new LogData()
						...
						.toString())
				.logInfo());
		getIncomingConnection().getConnector().pauseTransmission(getIncomingConnection().getNodeId());
	}
}